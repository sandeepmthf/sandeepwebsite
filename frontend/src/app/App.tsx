...
import { Mail, Phone, Linkedin, Github, ExternalLink, Award, Code, Code2, Briefcase, GraduationCap, Trophy, Download, ArrowUp } from 'lucide-react';
            ...
            >
              {[
                ...
                <motion.a
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="group flex items-center gap-2 px-4 py-2 rounded-full bg-accent/50 hover:bg-gradient-to-r hover:from-orange-500/10 hover:to-red-500/10 border border-transparent hover:border-primary/30 transition-all"
                >
                  <motion.div
